<template>
  <div>
    <div class="mb-4">
      <UFormGroup label="Current avatar" class="w-full" help="This would be blank by default foo">
...
const saveAvatar = async () => {
  ...
  const fileName = `${Math.floor(Math.random() * 9_000_000_000_000) + 1_000_000_000_000}.${fileExt}`
